...
import com.edugobeti.cursomc.domain.Estado;
import com.edugobeti.cursomc.domain.ItemPedido;
import com.edugobeti.cursomc.domain.Pagamento;
import com.edugobeti.cursomc.domain.PagamentoComBoleto;
import com.edugobeti.cursomc.domain.PagamentoComCartao;
...
import com.edugobeti.cursomc.repository.CategoriaRepository;
import com.edugobeti.cursomc.repository.CidadeRepository;
import com.edugobeti.cursomc.repository.ClienteRepository;
import com.edugobeti.cursomc.repository.EnderecoRepository;
import com.edugobeti.cursomc.repository.EstadoRepository;
...
import com.edugobeti.cursomc.repository.ProdutoRepository;
...
public class DbService {
	...
	public void instantiateTestDataBase() throws ParseException {
		...
		Categoria cat3 = new Categoria(null, "cama mesa ebanho");
		...
		Cliente cli1 = new Cliente(null, "Maria Gobeti", "maria@gmail.com", "36378912377", TipoCliente.PESSOA_FISICA);
		
		cli1.getTelefones().addAll(Arrays.asList("27363326","994695823"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apt 203", "Jardim", "13456908", cli1, c1);
		Endereco e2 = new Endereco(null, "AV Matos", "105", "Sala 800", "Centro", "0123499590", cli1, c2);
		...
		Pedido ped1 = new Pedido(null, sdf.parse("30/07/2017 10:12"), cli1, e1);
